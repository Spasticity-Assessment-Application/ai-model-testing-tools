...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    override func application(
        ...
        let channel = FlutterMethodChannel(name: "pose_native", binaryMessenger: controller.binaryMessenger)
    ...
    private func handlePoseEstimation(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        guard let poseService = poseService else {
            result(FlutterError(code: "SERVICE_UNAVAILABLE", message: "Pose service not initialized", details: nil))
            return
        }
        ...
        do {
            ...
            result(FlutterError(code: "POSE_ESTIMATION_FAILED", message: error.localizedDescription, details: nil))
        } catch {
